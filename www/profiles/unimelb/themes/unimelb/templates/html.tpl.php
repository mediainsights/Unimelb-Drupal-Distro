...
body.html.home.front {
    background: url("<?php print $files_directory . 'images/homepage-blue.jpg'; ?>") repeat-x scroll center top transparent !important;
}

body.html.blue.not-front {
    background: url("<?php print $files_directory . 'images/blue.jpg'; ?>") repeat-x scroll center top transparent !important;
}
