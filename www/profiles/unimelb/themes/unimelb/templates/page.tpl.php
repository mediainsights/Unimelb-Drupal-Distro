...
<div id="g-local-global-search">
    <div id="g-local-global-search-overlay" class="active">
<label><span>Search this site</span><?php $block = module_invoke('search', 'block_view', 'search'); print render($block); ?><label>
    </div>
</div>
...
<?php if(variable_get('unimelb_settings_ht-right') && $is_front) { ?><div id="headingtext">
        ...
        <p class="col-5"><?php print variable_get('unimelb_settings_ht-right'); ?></p>
        <hr>
      </div><?php } ?>
